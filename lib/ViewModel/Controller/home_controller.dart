...
import 'package:mvvm_weather_with_apis_getx/Repository/home_repository.dart';
...
class HomeController extends GetxController
{
  ...
  setHour(int index)
  {
    Timer(const Duration(milliseconds: 100),() => animater.value = true);
    currentIndex.value = index;
    hours.value = model.value!.days![0].hours![index];
    Timer(const Duration(milliseconds: 100),() => animater.value = false);
  }
